...
public record LinkResponse(UUID id, String customAlias, Integer clickCount, String longUrl, String shortUrl, String redirectUrl, String urlQrCode, LocalDateTime createdAt) {
